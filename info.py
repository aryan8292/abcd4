...
BOT_USERNAME = environ.get("BOT_USERNAME", "ARY_BOTZ")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001756081670') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://unknown4u1082:unknown4u1082@cluster0.hpvim.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ary_ backups') #Support group link ( make sure bot is admin )
